...
function createSliders() {
    ...
    infoLabel.innerText = 'Нажмите "F4" для активации';
    ...
    const savedContrast = localStorage.getItem('constrast') || 1;
...
function showPopup() {
    ...
    popup.innerText = 'Нажмите "F4" для активации';
