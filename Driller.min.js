...
function createSliders() {
    ...
    infoLabel.innerText = 'Нажмите "(-)" для активации';
    ...
    const savedBrightness = localStorage.getItem('Яркость') || 1;
    const savedSaturation = localStorage.getItem('Насыщенность') || 1;
    const savedContrast = localStorage.getItem('Контраст') || 1;
    const savedVibrance = localStorage.getItem('Вибрация') || 1;
